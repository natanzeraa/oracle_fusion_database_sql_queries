select *
  from (
   select pu.person_id,
          ...
          (
             select ppn2.full_name
               from per_person_names_f ppn2
              where ppn2.person_id = px.supervisor_id
