...
where
  ...
  -- and trunc(from_tz(cast(ps.creation_date as timestamp), 'utc') at time zone 'america/sao_paulo') between to_date('13/11/2025', 'dd/mm/yyyy') and to_date('25/11/2025', 'dd/mm/yyyy') -- Fornecedor   
order by
